...
const WALLET_I18N: Record<string, any> = {
  EN: {
    ...
    description: "AppsMiner's layered wallet architecture keeps your liquid funds accessible and your long-term holdings impenetrable.",
  ...
  AR: {
    ...
    description: "تحافظ بنية المحفظة متعددة الطبقات من AppsMiner على إمكانية الوصول إلى أموالك السائلة بينما تجعل ممتلكاتك طويلة الأجل غير قابلة للاختراق.",
  ...
  HI: {
    ...
    description: "AppsMiner का स्तरित वॉलेट आर्किटेक्चर आपके तरल फंड को सुलभ रखता है और आपकी दीर्घकालिक संपत्ति को अभेद्य बनाता है।",
  ...
  DE: {
    ...
    hybrid: "Hybrides",
    walletSystem: "Wallet-System",
    description: "Die mehrschichtige Wallet-Architektur von AppsMiner hält Ihre liquiden Mittel griffbereit und schützt Ihr langfristiges Vermögen kompromisslos.",
  ...
  FR: {
    ...
    description: "L'architecture multicouche de portefeuille d'AppsMiner permet de garder vos fonds liquides accessibles tout en protégeant vos avoirs à long terme de manière inviolable.",
  ...
  ES: {
    ...
    description: "La arquitectura multicapa de AppsMiner mantiene sus fondos líquidos listos para operar mientras sus activos principales permanecen inexpugnables.",
